class ScoreItem extends Phaser.GameObjects.Container {
  ...
  constructor(x, y, number, name, score) {
    ...
    // frame.setOrigin(0);
    // this.add(frame);
    let num = scene.add.bitmapText(90, 6, "normal", displayNumber(number) + ".", 24);
    ...
    num.setOrigin(1, 0);
    this.add(num);
    this.add(scene.add.bitmapText(98, 6, "normal", name, 24))
    this.add(scene.add.bitmapText(380, 6, "lightNumbers", displayNumber(score), 24))
    // this.add(
